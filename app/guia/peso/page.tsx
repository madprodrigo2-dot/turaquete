      ...
      <article className="max-w-2xl mx-auto px-5 md:px-6 py-10 md:py-14">
        ...
        <header className="mb-10">
          ...
          <p className="text-tinta/70 text-lg leading-relaxed">
            O peso é o primeiro número que aparece na ficha técnica de qualquer raquete. A faixa típica vai de 330 g a 385 g, mas a diferença de 20 gramas no jogo é maior do que parece.
          </p>
        </header>
