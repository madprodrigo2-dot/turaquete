...
<!-- AUTO-GEN:cabecera -->
_Versão: 0.3.841 · Hash: b43bc61 · Gerado em: 2026-07-11_
<!-- /AUTO-GEN:cabecera -->
...
| Forgiveness floor para pool de iniciante | `≤5 → excluída do pool` | `lib/recommend.ts:257` |
| isAvancadaParaFiltro (gate de filtragem) | `f≤4 | (f≤6 & (p≥8|c≥9)) | (f≤7 & p≥9)` | `lib/recommend.ts:244` |
